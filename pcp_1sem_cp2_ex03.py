...
if cp1<cp2 and cp1<cp3:
    ...
    print()
    print(f"A sua média sem os pesos é {mediasempeso1:.2f}")
...
if cp2<cp1 and cp2<cp3:
    ...
    print()
    print(f"A sua média sem os pesos é {mediasempeso2:.2f}")
...
if cp3<cp1 and cp3<cp2:
    ...
    print()
    print(f"A sua média sem os pesos é {mediasempeso3:.2f}")
